...
export function DocumentDetailPage({ document, onBack }: { document: DocumentItem; onBack: () => void }) {
  return (
    <>
      <PageHeader title={document.fileName} description="Document metadata, preview actions, permissions, and history." action={<button onClick={onBack}>Back</button>} />
